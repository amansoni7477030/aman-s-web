...
<body>
  <header class="header">
    <nav class="nav">
      <h1 class="logo">Aman's Web&nbsp&nbsp;</h1> <!-- Logo and navigation -->
      <ul class="nav-links">
  ...
  <section class="products section" id="products"> <!-- Products section -->
  ...
  <section class="about section" id="about"> <!-- About Us section -->
  ...
  <section class="contact section" id="contact"> <!-- Contact Us section -->
    <h2 class="section-title">Contact Us</h2>
    <p class="section-subtitle">Get in touch with us</p>

    <form action="#" method="post" class="contact-form" id="contact-form"> <!-- Contact form -->
